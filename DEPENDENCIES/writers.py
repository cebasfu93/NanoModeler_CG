...
def top_writer(TMP, np_xyz, lig_bonds, lig_angles, inp):
    n_core = len(np_xyz) - inp.lig1_num - inp.lig2_num
    n_at1 = len(inp.lig1_btypes)
    n_at2 = len(inp.lig2_btypes)
    ...
    for i in range(inp.lig1_num):
        ...
        for j, btype, charge, mass in zip(jumps, inp.lig1_btypes, inp.lig1_charges, inp.lig1_masses):
            q_tot += charge
    ...
    for i in range(inp.lig2_num):
        ...
        for j, btype, charge, mass in zip(jumps, inp.lig2_btypes, inp.lig2_charges, inp.lig2_masses):
            q_tot += charge
    ...
    for bond in lig_bonds[0]:
        at1 = bond[0] + 1
        at2 = bond[1] + 1
        f.write("{:>5d} {:>5d} {:>6d} {:>13.5f} {:>13.1f}\n".format(at1, at2, 1, 2*inp.bead_radius, inp.lig1_bond_k))
    for bond in lig_bonds[1]:
        at1 = bond[0] + 1
        at2 = bond[1] + 1
        f.write("{:>5d} {:>5d} {:>6d} {:>13.5f} {:>13.1f}\n".format(at1, at2, 1, 2*inp.bead_radius, inp.lig2_bond_k))
    ...
    for angle in lig_angles[0]:
        ...
        at2 = angle[1] + 1
        at3 = angle[2] + 1
        f.write("{:>5d} {:>5d} {:>5d} {:>6d} {:>9.4e}  {:>9.4e}\n".format(at1, at2, at3, 1, 180, inp.lig1_angle_k))
    for angle in lig_angles[1]:
        at1 = angle[0] + 1
        at2 = angle[1] + 1
        at3 = angle[2] + 1
        f.write("{:>5d} {:>5d} {:>5d} {:>6d} {:>9.4e}  {:>9.4e}\n".format(at1, at2, at3, 1, 180, inp.lig2_angle_k))
