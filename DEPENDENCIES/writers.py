...
def gro_writer(TMP, np_xyz, inp):
    ...
    logging.info("\tWriting the ligands...")
...
def top_writer(TMP, np_xyz, lig_bonds, lig_angles, inp, params):
    ...
    logging.info("\tWriting [ moleculetype ]...")
    f.write("\n[ moleculetype ]\n")
    f.write("NP \t\t 3\n")

    logging.info("\tWriting [ atoms ]...")
    f.write("\n[ atoms ]\n")
