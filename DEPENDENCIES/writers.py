...
def top_writer(TMP, np_xyz, core_bonds, lig_bonds, lig_angles, lig_dihedrals, inp, params):
    ...
    f.write("#include \"MARTINI/martini_v2.2refPolIon.itp\" ; From Marrink, S. J. 2007 DOI: 10.1021/jp071097f and Michalowsky, J. 2017 DOI: 10.1063/1.4974833\n")
    f.write("#include \"MARTINI/martini_v2.2ions.itp\" ; From Michalowsky, J. 2018 DOI: 10.1063/1.5028354\n")
    f.write("#include \"MARTINI/martini_v2.0solvents.itp\" ; From Marrink, S. J. 2007 DOI: 10.1021/jp071097f\n")
    ...
    for bond in core_bonds:
        bond_comment = "core EN"
        if len(bond) == 3:
            bond_comment += " antipodal"
        at1 = bond[0] + 1
        at2 = bond[1] + 1
        b_key = "{}-{}".format(btypes[bond[0]], btypes[bond[1]])
        f.write("{:>5d} {:>5d} {:>6d} {:>13.5f} {:>13.1f} ; {} \n".format(at1, at2, 1, 2*inp.bead_radius, inp.core_en_k, bond_comment))
